        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10,),
              Text(
                "COVIDIGITAL-19 is an open source app made with Flutter framework to provide the status of Covid-19 pandemic all over the world. It shows all the affected, recovered and dead count for each country in a form of graph. As it is an open source app feel free to contibute in GitHub.",
                style: TextStyle(
                  fontSize: 15,
                  color: Color(0xff057163)
                ),
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Text(" by "),
                  Text("Group Haziq",style: TextStyle(fontWeight: FontWeight.bold),)
                ],
              )
            ],
          ),
